...
shell_exec('cat /my/jd.txt  /my/Temperature-data.ods >> /home/pi/Tempreture-logger/Data/Temperature-data.csv');
shell_exec("rm /my/jd.txt"); 
shell_exec("rm /my/Temperature-data.ods");



echo ("Click link to Download<br>");
echo ("<a href= Temperature-data.csv download><span>DOWNLOAD</span></a>");
echo("<a href=\"delete.php\"  
				style=\"text-decoration:underline;\"
				><font color=\"blue\"><br><br><big>Back</big></font></a>");
die();
?>